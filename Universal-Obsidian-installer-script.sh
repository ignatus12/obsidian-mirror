...
#
#  USAGE
#      sh Universal-Obsidian-installer-script.sh              install
#      sh Universal-Obsidian-installer-script.sh --uninstall  remove
#      sh Universal-Obsidian-installer-script.sh --help
#
#  THEN
